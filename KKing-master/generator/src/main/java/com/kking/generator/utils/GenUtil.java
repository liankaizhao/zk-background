...
public class GenUtil {
    ...
    public static List<String> getTemplates()
    {
        ...
        templates.add("generator/src/main/resources/templates/vm/entity/.java.vm");
        templates.add("generator/src/main/resources/templates/vm/mapper/Mapper.java.vm");
        templates.add("generator/src/main/resources/templates/vm/mapper/Mapper.xml.vm");
        templates.add("generator/src/main/resources/templates/vm/service/Service.java.vm");
        templates.add("generator/src/main/resources/templates/vm/service/impl/ServiceImpl.java.vm");
        return templates;
    }
