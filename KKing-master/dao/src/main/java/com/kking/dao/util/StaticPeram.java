 ...
 * @author zhaoliancan
 * @version 1.0.0
 * @ClassName StaticPeram.java
 * @Description TODO
 * @createTime 2019年11月13日 17:40:00
 */
public class StaticPeram {
    ...
    // 替换成你的AK (产品密)
    final static String accessKeyId = "LTAI4FpEkFn6roJGyrv59rvM";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
    final static String accessKeySecret = "zFFKWQHwEkvCaMabRjvtXReNtGNtEd";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
    // 必填:短信签名-可在短信控制台中找到
    final static String SignName = "31231";
    // 必填:短信模板-可在短信控制台中找到
    final static String TemplateCode = "SMS_177360113"; // 阿里云配置你自己的短信模板填入
